...
export default function PostList() {
  ...
  const fetchPosts = async () => {
    ...
    try {
      ...
      setPosts(categories);
      setTotalPosts(pagination.totalCategories);
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this post?")) {
      try {
        await axios.delete(`/api/news-category?id=${id}`);
          ...
          <div className="p-4">
            ...
            <div className="row mb-3">
              ...
              <div className="col-md-6 d-flex justify-content-end">
                <Link href={"/us/newsCategory/create"}>
                    ...
                    posts.map((post) => (
                      <tr key={post._id}>
                        ...
                        <td>
                          ...
                          <Link href={`/us/newsCategory/update?id=${post._id}`}> <button className="btn btn-sm btn-primary me-2">Edit</button></Link>
                          <button
