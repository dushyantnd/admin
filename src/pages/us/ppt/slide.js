...
const PPTPage = () => {
    ...
    const [textEntries, setTextEntries] = useState([
        { entries: [{ title: '', description: '' }] } // Default slide with properly initialized entries
    ]);
                                    ...
                                    <div key={entryIndex} className="mb-3 row">
                                        <Form.Group className="col-md-5">
                                            <Form.Control
                                                ...
                                                value={entry.title || ''} // Fallback to an empty string
                                                onChange={(en) =>
                                                    setTextEntries(
                                                        textEntries.map((s, i) =>
                                                            i === slideIndex
                                        ...
                                        <Form.Group className="col-md-6">
                                            <Form.Control
                                                ...
                                                value={entry.description || ''} // Fallback to an empty string
                                                onChange={(en) =>
                                                    setTextEntries(
                                                        textEntries.map((s, i) =>
                                                            i === slideIndex
